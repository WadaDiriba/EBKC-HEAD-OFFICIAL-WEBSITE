...
import { FaMapMarkerAlt, FaPhoneAlt, FaClock, FaInbox } from "react-icons/fa";
...
export default function Contact() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    try {
      const mailtoLink = `mailto:EBKC12@Yahoo.com?subject=${encodeURIComponent(
        formData.subject
            ...
            <div className={styles.infoList}>
              {contactInfo.map((info, index) => (
                <div key={index} className={styles.infoItem}>
                  ...
                  {info.href ? (
                    <a href={info.href} className={styles.infoText} target="_blank" rel="noopener noreferrer">
                      {info.label}
                    </a>
                  ) : (
          ...
          <div className={styles.formCard}>
            {isSubmitted ? (
              <div className={styles.successMessage}>
                ...
                <button className={styles.sendAnother} onClick={() => setIsSubmitted(false)}>
